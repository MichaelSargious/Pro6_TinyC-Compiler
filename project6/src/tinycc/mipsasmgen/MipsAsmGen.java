...
public class MipsAsmGen {
	...
	/**
	 * Emits a memory instruction.
	 * The effective address is the sum of the address of the label, the offset and value of the register.
	 ...
	 */
	public void emitInstruction(final MemoryInstruction insn, final GPRegister dest, final Label label, final int offset, final GPRegister register) {
	 ...
	 * @remarks Emits into the text segment.
	 */
	public void emitInstruction(final RegisterInstruction insn, final GPRegister dest, final GPRegister left, final GPRegister right) {
	...
	/**
	 * Emits a register instruction which operates on two registers and stores the result in a register.
	 * In this variant the left operand is the same as the destination.
	 * @param insn The register-instruction type to emit.
	 * @param dest The destination register.
	 * @param right The register of the right operand.
	 * @remarks Emits into the text segment.
	 ...
	 * @remarks Emits into the text segment.
	 */
	public void emitInstruction(final ImmediateInstruction insn, final GPRegister dest, final GPRegister left, final int imm) {
	...
	/**
	 * Emits an instruction which takes an additional immediate constant.
	 * In this variant the left operand is the same as the destination, except for LUI, which uses ZERO.
	 * @param insn The instruction type to emit.
	 * @param dest The destination register.
	 * @param imm The immediate constant to use. This must be in range for the used instruction.
	 * @remarks Emits into the text segment.
	 ...
	 * @param right The right operand for a conditional branch (BEQ and BNE).
	 *              Must be ZERO for all other branch-instruction types.
	 * @param target The target text label to jump to.
	 * @remarks Emits into the text segment.
	 */
	public void emitInstruction(final BranchInstruction insn, final GPRegister left, final GPRegister right, final TextLabel target) {
